...
const FormAdminWisata = ({ detail, handleChange, handleSubmit }) => {
  return (
    <>
      <section>
        <h1 className="text-4xl font-medium text-primary mb-10">
          Update Wisata
        </h1>
        <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
          <div>
            <label
              for="gambar"
              className="font-medium text-primary text-[20px] block mb-2"
            >
              Gambar
            </label>
            <div className="flex items-center gap-4">
              <input
                ...
                disabled
                className="block bg-primary border-2 border-accent outline-none text-white p-5 rounded-[10px] text-[18px]"
              />
          ...
          <div>
            ...
            <input
              ...
              value={detail.nama}
              onChange={handleChange}
              className="block w-full bg-primary border-2 border-accent outline-none text-white p-5 rounded-[10px] text-[18px]"
            />
          </div>
          <div>
            <label
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              value={detail.kontak}
              className="block w-1/4 bg-primary border-2 border-accent outline-none text-white p-5 rounded-[10px] text-[18px]"
            />
          </div>
          ...
          <div>
            ...
            <TextareaAutosize
              ...
              onChange={handleChange}
              className="w-full block bg-primary border-2 border-accent outline-none text-white p-6 rounded-[10px] text-[18px]"
            />
          </div>
          <button
            type="submit"
            className="bg-secondary w-fit self-end text-white rounded-xl py-2 px-10 font-medium mb-5"
          >
            Submit
          </button>
        </form>
...
export default FormAdminWisata;
