...
const FormAdminInformasi = ({ detail, handleChange, handleSubmit }) => {
  return (
    <>
      <section>
        ...
        <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="bg-secondary w-fit self-end mb-6 text-white rounded-xl py-2 px-10 font-medium"
          >
            Submit
          </button>
        </form>
