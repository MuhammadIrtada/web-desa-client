const ButtonDelete = () => {
  return (
    <svg
      className="w-9 h-10 cursor-pointer stroke-white absolute z-10 hover:bg-accent hover:stroke-secondary duration-100 top-1 left-1 bg-secondary rounded-full stroke-2 border-2 border-primary ml-2 mt-2"
      viewBox="0 0 34 36"
      fill="none"
