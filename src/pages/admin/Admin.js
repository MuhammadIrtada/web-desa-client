...
const Admin = () => {
  ...
  const activeNav =
    "py-2 px-3 flex items-center gap-4 font-medium rounded-xl bg-secondary text-white";
      ...
      <div className="flex w-full min-h-screen ">
        ...
        >
          <div className="flex gap-2 items-center mb-10">
            ...
            <h1 className="font-semibold text-2xl text-white">Desa Sumberpucung</h1>
          </div>
          <div className="flex flex-col text-white text-lg gap-4">
            {/* NavLink Desa */}
            <NavLink
              to={"/admin/"}
            ...
            >
              {({ isActive }) => (
                <>
                  <svg
                    className={`${
                      isActive ? "fill-white" : "fill-white"
                    } w-[27px] h-[27px]`}
                    viewBox="0 0 27 27"
                    fill="none"
                  ...
                  <h1>Informasi Desa Sumberpucung</h1>
                </>
              )}
            </NavLink>
            {/* Navlink Informasi */}
            ...
            <button className={navLInk} onClick={handleLogOut}>
              <img className="w-[27px] h-[27px]" src={ic_logout} alt="icon-logout" />
              Log Out
            </button>
          </div>
        </nav>
        ...
        >
          <div
            ...
            style={{ backgroundImage: `url(${bgPrimary})` }}
          >
            <h1 className=" text-end font-medium text-2xl text-primary">
              Halo Admin!
            </h1>
          </div>
