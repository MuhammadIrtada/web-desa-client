...
// Gambar
import hero from "../assets/balai-desa.png";
import about from "../assets/about.png";
import visiMisi from "../assets/visi misi.jpg";
    ...
    <>
      ...
      >
        <div className="w-5/6 mx-auto h-full flex items-center">
          <div className="text-white">
            <h1 className="text-[44px] font-bold">Selamat Datang!</h1>
            <h2 className="text-[30px]">
              Desa Sumberpucung <br/>
              Kecamatan Sumberpucung, Kabupaten Malang <br/>
              Jawa Timur
            </h2>
          </div>
        </div>
      ...
      >
        <div className="w-5/6 py-[120px] mx-auto">
          <div className="w-full flex justify-between gap-44">
            <div className="w-3/5">
              <h1 className="text-[44px] text-white mb-6">
                <span className="font-medium">Visi</span> dan{" "}
                <span className="font-medium">Misi <br/>Desa Sumberpucung</span>
              </h1>
              <div className="rounded-[60px] bg-white flex justify-around relative overflow-hidden mb-6 text-2xl font-medium cursor-pointer">
                <h2
                  className={`${
                    openVisi
                      ? "bg-secondary text-white rounded-[60px]"
                      : "bg-white"
      ...
      >
        <div className="w-5/6 py-[120px] mx-auto">
          ...
          >
            <p className="bg-secondary py-2 px-6 rounded-lg text-white font-medium text-2xl drop-shadow-lg">
              Informasi Lainnya
            </p>
          </Link>
        </div>
      ...
      >
        <div className="w-5/6 py-[120px] mx-auto">
          <div className="w-full text-white">
            ...
            <h2 className="text-[44px] font-medium">Desa Sumberpucung</h2>
          </div>
          ...
          <Link to={"/umkm"} className="w-full flex justify-center">
            <button className="bg-secondary py-2 px-6 rounded-lg text-white font-medium text-2xl drop-shadow-lg">
              UMKM Lainnya
            </button>
          </Link>
        </div>
